    ...
    <div class="max-w-4xl mx-auto p-6 space-y-6">
      ...
      <section class="border-t border-surface1 pt-4 mt-6">
        ...
        <div class="grid grid-cols-2 gap-2 text-xs text-subtext0">
          <div><code class="text-mauve">{`{{char}}`}</code> — Character name</div>
          <div><code class="text-mauve">{`{{user}}`}</code> — User name</div>
          <div><code class="text-mauve">{`{{description}}`}</code> — Character description</div>
          <div><code class="text-mauve">{`{{personality}}`}</code> — Personality</div>
          <div><code class="text-mauve">{`{{scenario}}`}</code> — Scenario</div>
          <div><code class="text-mauve">{`{{slot}}`}</code> — Resolved content (in inner format)</div>
          <div><code class="text-mauve">{`{{scene.location}}`}</code> — Scene location</div>
          <div><code class="text-mauve">{`{{var.*}}`}</code> — Variable store values</div>
        </div>
      </section>
    </div>
  </div>
